// Check if this is being loaded directly or imported by another service worker
// If loaded directly, initialize Firebase immediately
if (!self.firebase) {
  importScripts(
...
// Get the Firebase messaging instance - make sure it's always available
const messagingInstance = self.firebase ? firebase.messaging() : messaging;
